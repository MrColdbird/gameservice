...
#define CELL_GCMUTIL_TEXTURE_REMAP_ARGB (CELL_GCM_TEXTURE_REMAP_REMAP << 14 | CELL_GCM_TEXTURE_REMAP_REMAP << 12 | CELL_GCM_TEXTURE_REMAP_REMAP << 10 | CELL_GCM_TEXTURE_REMAP_REMAP <<  8 | CELL_GCM_TEXTURE_REMAP_FROM_B << 6 | CELL_GCM_TEXTURE_REMAP_FROM_G << 4 | CELL_GCM_TEXTURE_REMAP_FROM_R << 2 | CELL_GCM_TEXTURE_REMAP_FROM_A)

#define CELL_GCMUTIL_TILE_ALIGN_HEIGHT(location) (location == CELL_GCM_LOCATION_LOCAL? CELL_GCM_TILE_LOCAL_ALIGN_HEIGHT: CELL_GCM_TILE_MAIN_ALIGN_HEIGHT)
